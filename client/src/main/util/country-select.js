...
export default function CountrySelect(props) {
    ...
    const countries = [
        ...
        {
            code: 'CH',
            label: t('profile.fields.address.countries.ch', 'Switzerland'),
            suggested: true,
        },
        ...
        {
            code: 'FR',
            label: t('profile.fields.address.countries.fr', 'France'),
        },
        { code: 'GA', label: 'Gabon' },
        {
            code: 'GB',
            label: t('profile.fields.address.countries.en', 'United Kingdom'),
        },
        ...
        {
            code: 'IT',
            label: t('profile.fields.address.countries.it', 'Italy'),
        },
    ...
    return (
        <Autocomplete
            ...
            renderInput={(params) => (
                <TextField
                    {...params}
                    label={t('profile.fields.address.country', 'Country')}
                    variant="outlined"
                    inputProps={{
                        ...params.inputProps,
